...
//            }})
    ...
    function abrir_notibar(action){
        $("#content_notificacion_arriba").css('top', '-555px');
        var alto= '0';
        jQuery.ajax({
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
              ...
              <td>
                  <table width="100%">
                      <tr style="background-color: white;">
                          ...
                          <tr>
                              <td colspan="3" height="5" bgcolor="#939090"></td>
                          </tr>
                        <tr align="left">
          ...
          <tr>
              <td colspan="2" class="barra_principal">
                  <!-- ############ ENCABEZADO ############ -->
                  <div style="position: absolute; top: 0px; left: 0px; z-index: 1900;">
                      <table style="height: 40px;" cellpadding="0" cellspacing="0">
                          <tr>
                              <td width="24"><a href="<?php echo sfConfig::get('sf_app_acceso_url'); ?>usuario/session"><img src="/images/icon/inicio.png"/></a></td>
                              <td>&nbsp;<a href="<?php echo sfConfig::get('sf_app_acceso_url'); ?>usuario/session">Inicio</a></td>
                              <td>&nbsp;&nbsp;</td>
                              <td width="24"><a href="<?php echo sfConfig::get('sf_app_acceso_url'); ?>usuario/salir"><img src="/images/icon/cerrarsession.png"/></a></td>
                              <td>&nbsp;<a href="<?php echo sfConfig::get('sf_app_acceso_url'); ?>usuario/salir">Salir</a></td>
                          </tr>
                      </table>
                  </div>

                  <div style="position: absolute; top: 0px; left: 40%; z-index: 1900;">
                      <ul id="noti_bar"></ul>
                  </div>

                  <div style="position: absolute; top: 0px; right: 0px; z-index: 1900;">
                      <table style="height: 40px;" cellpadding="0" cellspacing="0">
                          <tr>
                              <td class="mensaje_expira" style="display: none;">
                                  <div style="position: relative;">
                                    ...
                                    <div id="menu_expira" style="display: none; width:230px; position: absolute; top: 31px; background-color: #F5F5F5; border: solid 1px; text-align: justify; padding: 10px;">
                    ...
                    <td id ="eee" width = "30" valign="top" align="center">
                      ...
                      <div id="menuidex" style="position: fixed; width: 60px; height: 0px; z-index: 1000;">
                          <table cellpadding="0" cellspacing="0" id="rrrr">
                              <tr>
                                  <td>
                                      <div id="menuidin" style="position: absolute; top: -6px; left:-196px;" onMouseover="javascript:mostrarmenu()" onmouseout="javascript:ocultarmenu()">
                                          ...
                                          <div style="position: absolute; top: 0px; right: -17px;"><img src="/images/other/menu_open.png"></div>
                                      </div>

			...
			if (is_string($format)) {
				...
				switch (strtoupper($format)) {
					...
					case 'LETTER': {$format = array(612.00,792.00); break;}
                                        case 'RECIBO': {$format = array(612.00,396.00); break;}
		...
		public function Footer() {
			...
			if (!empty($barcode)) {
				...
				$this->write1DBarcode($barcode, 'C128B', $this->GetX(), $cur_y + $line_width, $barcode_width, (($this->getFooterMargin() / 3) - $line_width), 0.3, '', '');
                        ...
                        if(sfContext::getInstance()->getUser()->getAttribute('pie_pdf')=='normal')
                        {
                        ...
                        elseif(sfContext::getInstance()->getUser()->getAttribute('pie_pdf')=='rrhh')
                        {
                            $valides = 'Para validar ésta información ingrese a http://sigla.inavi.gob.ve e introduzca el siguiente codigo: '.sfContext::getInstance()->getUser()->getAttribute('documento_id');
                            
                            $this->SetY(700);
                            $this->SetFont('helvetica', '', 7);
                            $this->Cell(0, 0, 'Constancia válida por tres (3) meses', 'F', 0, 'L');
                            $this->SetY(710);
                            $this->SetFont('helvetica', '', 9);
                            $this->Cell(0, 0, $valides, 'F', 0, 'L');
                            $this->SetY(730);
                            $this->SetFont('helvetica', '', 9);
                            $this->Cell(0, 0, 'Torre Ministerial, Piso 02, Av. Universidad, Esquina El Chorro, Caracas - Venezuela', 'T', 0, 'C');
                            $this->SetY(740);
                            $this->Cell(0, 10, 'Telfs: 58-0212-596.53.54 / 58-0212-596.51.67 Fax: 58-0212-596.53.40', 'F', 0, 'C');
                            $this->SetY(750);
                            $this->Cell(0, 10, 'Dirección Web:www.inavi.gob.ve', 'F', 0, 'C');
                            $this->SetY(760);
                            $this->Cell(0, 10, 'RIF G-20003024-0', 'F', 0, 'C');
                        }

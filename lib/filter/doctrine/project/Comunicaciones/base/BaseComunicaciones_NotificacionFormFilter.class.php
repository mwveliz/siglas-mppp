...
/**
 * Comunicaciones_Notificacion filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseComunicaciones_NotificacionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id_update'      => new sfValidatorPass(array('required' => false)),
      'ip_update'      => new sfValidatorPass(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('comunicaciones_notificacion_filters[%s]');

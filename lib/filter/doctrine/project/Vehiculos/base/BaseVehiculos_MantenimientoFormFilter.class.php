...
/**
 * Vehiculos_Mantenimiento filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseVehiculos_MantenimientoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mantenimiento_tipo_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Vehiculos_MantenimientoTipo'), 'add_empty' => true)),
      'observacion'           => new sfWidgetFormFilterInput(),
      'kilometraje'           => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'mantenimiento_tipo_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Vehiculos_MantenimientoTipo'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('vehiculos_mantenimiento_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'mantenimiento_tipo_id' => 'ForeignKey',
      'observacion'           => 'Text',
      'kilometraje'           => 'Number',
      'fecha'                 => 'Date',
      'status'                => 'Text',

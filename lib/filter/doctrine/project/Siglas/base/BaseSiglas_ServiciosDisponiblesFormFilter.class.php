...
/**
 * Siglas_ServiciosDisponibles filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseSiglas_ServiciosDisponiblesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('siglas_servicios_disponibles_filters[%s]');

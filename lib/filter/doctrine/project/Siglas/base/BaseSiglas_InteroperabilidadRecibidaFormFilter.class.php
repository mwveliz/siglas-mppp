...
/**
 * Siglas_InteroperabilidadRecibida filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseSiglas_InteroperabilidadRecibidaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('siglas_interoperabilidad_recibida_filters[%s]');

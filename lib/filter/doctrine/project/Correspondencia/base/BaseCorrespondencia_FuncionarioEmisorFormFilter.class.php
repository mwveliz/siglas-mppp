...
/**
 * Correspondencia_FuncionarioEmisor filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseCorrespondencia_FuncionarioEmisorFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'accion_delegada_id'            => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Acceso_AccionDelegada'), 'column' => 'id')),
      ...
      'funcionario_delegado_cargo_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Funcionarios_FuncionarioCargoDelegado'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('correspondencia_funcionario_emisor_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'firma'                         => 'Text',
      'accion_delegada_id'            => 'ForeignKey',
      'funcionario_delegado_id'       => 'ForeignKey',
      'funcionario_delegado_cargo_id' => 'ForeignKey',
      'id_update'                     => 'Number',
      'ip_update'                     => 'Text',
      'proteccion'                    => 'Text',
      'created_at'                    => 'Date',

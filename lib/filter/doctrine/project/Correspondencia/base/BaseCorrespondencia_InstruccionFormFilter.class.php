...
/**
 * Correspondencia_Instruccion filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseCorrespondencia_InstruccionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('correspondencia_instruccion_filters[%s]');

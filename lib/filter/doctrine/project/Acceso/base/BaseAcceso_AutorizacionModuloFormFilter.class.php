...
/**
 * Acceso_AutorizacionModulo filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseAcceso_AutorizacionModuloFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'permiso'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->widgetSchema->setNameFormat('acceso_autorizacion_modulo_filters[%s]');

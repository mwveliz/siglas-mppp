...
/**
 * Acceso_UsuarioPerfil filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseAcceso_UsuarioPerfilFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('acceso_usuario_perfil_filters[%s]');

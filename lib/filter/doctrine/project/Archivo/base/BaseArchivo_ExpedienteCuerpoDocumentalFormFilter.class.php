...
/**
 * Archivo_ExpedienteCuerpoDocumental filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseArchivo_ExpedienteCuerpoDocumentalFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('archivo_expediente_cuerpo_documental_filters[%s]');

...
/**
 * Archivo_CajaModelo filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseArchivo_CajaModeloFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('archivo_caja_modelo_filters[%s]');

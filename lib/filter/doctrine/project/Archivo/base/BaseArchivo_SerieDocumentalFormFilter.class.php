...
/**
 * Archivo_SerieDocumental filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseArchivo_SerieDocumentalFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('archivo_serie_documental_filters[%s]');

...
/**
 * Funcionarios_FamiliarEnfermedad filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseFuncionarios_FamiliarEnfermedadFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('funcionarios_familiar_enfermedad_filters[%s]');

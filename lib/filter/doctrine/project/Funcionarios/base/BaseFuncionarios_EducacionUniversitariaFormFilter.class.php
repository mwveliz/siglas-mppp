...
/**
 * Funcionarios_EducacionUniversitaria filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseFuncionarios_EducacionUniversitariaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'carrera_id'             => new sfWidgetFormFilterInput(),
      ...
      'segmento'               => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'carrera_id'             => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'segmento'               => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('funcionarios_educacion_universitaria_filters[%s]');

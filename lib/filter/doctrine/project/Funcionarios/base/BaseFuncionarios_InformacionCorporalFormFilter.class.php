...
/**
 * Funcionarios_InformacionCorporal filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseFuncionarios_InformacionCorporalFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tipo_sangre'    => new sfWidgetFormFilterInput(),
      'lentes_formula' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'tipo_sangre'    => new sfValidatorPass(array('required' => false)),
      'lentes_formula' => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('funcionarios_informacion_corporal_filters[%s]');

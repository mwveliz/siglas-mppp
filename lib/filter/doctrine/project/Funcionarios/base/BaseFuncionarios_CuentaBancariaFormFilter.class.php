...
/**
 * Funcionarios_CuentaBancaria filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseFuncionarios_CuentaBancariaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'banco_id'       => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Public_Banco'), 'add_empty' => true)),
      'tipo'           => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'n_cuenta'       => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'banco_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Public_Banco'), 'column' => 'id')),
      'tipo'           => new sfValidatorPass(array('required' => false)),
      'n_cuenta'       => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('funcionarios_cuenta_bancaria_filters[%s]');

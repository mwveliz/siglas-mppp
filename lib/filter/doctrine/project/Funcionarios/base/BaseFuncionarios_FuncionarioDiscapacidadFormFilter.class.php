...
/**
 * Funcionarios_FuncionarioDiscapacidad filter form base class.
 *
 * @package    siglas
 * @subpackage filter
 * @author     Livio Lopez
 ...
 */
abstract class BaseFuncionarios_FuncionarioDiscapacidadFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('funcionarios_funcionario_discapacidad_filters[%s]');

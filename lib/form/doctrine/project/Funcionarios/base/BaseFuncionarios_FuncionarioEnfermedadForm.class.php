...
/**
 * Funcionarios_FuncionarioEnfermedad form base class.
 *
 * @method Funcionarios_FuncionarioEnfermedad getObject() Returns the current form's model object
 *
 * @package    siglas
 * @subpackage form
 * @author     Livio Lopez
 ...
 */
abstract class BaseFuncionarios_FuncionarioEnfermedadForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('funcionarios_funcionario_enfermedad[%s]');

...
/**
 * Correspondencia_Instruccion form base class.
 *
 * @method Correspondencia_Instruccion getObject() Returns the current form's model object
 *
 * @package    siglas
 * @subpackage form
 * @author     Livio Lopez
 ...
 */
abstract class BaseCorrespondencia_InstruccionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('correspondencia_instruccion[%s]');
  ...
  {
    return 'Correspondencia_Instruccion';
  }

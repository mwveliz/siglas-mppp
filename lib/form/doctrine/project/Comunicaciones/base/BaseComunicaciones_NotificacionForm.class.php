...
/**
 * Comunicaciones_Notificacion form base class.
 *
 * @method Comunicaciones_Notificacion getObject() Returns the current form's model object
 *
 * @package    siglas
 * @subpackage form
 * @author     Livio Lopez
 ...
 */
abstract class BaseComunicaciones_NotificacionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id_update'      => new sfValidatorString(array('max_length' => 50)),
      'ip_update'      => new sfValidatorString(array('max_length' => 30)),
    ));

    $this->widgetSchema->setNameFormat('comunicaciones_notificacion[%s]');
  ...
  {
    return 'Comunicaciones_Notificacion';
  }

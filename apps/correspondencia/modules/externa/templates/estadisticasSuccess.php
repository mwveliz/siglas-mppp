    ...
    function abrir_estadistica() {
        ...
        $('#estadistica_unidad_id').removeAttr('style');
            $('#div_estadisticas_correspondencia').html('<?php echo image_tag('icon/cargando.gif', array('size'=>'25x25')); ?> Generando grafico ...');
                ...
                'url' => 'externa/estadisticaSeleccionada',
...
<h1>Estadisticas de Correspondencia Externa</h1>
    <div id="sf_admin_header">

            <li class="sf_admin_action_back">
                <a href="<?php echo sfConfig::get('sf_app_correspondencia_url').'externa'; ?>">Regresar</a>
            </li>
                ...
                <div>
                    ...
                    <div class="content">
                        <select name="estadistica_tipo" id="estadistica_tipo">
                            <option value="totalStatusExterna">Total General</option>
                            <option value="totalStatusExternasParaOficinas">Total a oficinas</option>
                            <option value="totalExternaPorOrganismos">Total por organismos externos</option>
                            <option value="totalStatusExternasPorReceptor">Total por receptor</option>
                            <option value="totalExternaPorDias">Historico de cantidades</option>
                        </select>

                ...
                <td>
                    <table>
                        <tr class="without_border" style="font-size: 11px">
                            ...
                            <td class="without_border actual">Redactar</td>
                            <td class="without_border">Leer</td>
                            <td class="without_border actual">Recibir Externa</td>
                            <td class="without_border">Firmar</td>
                        ...
                        <?php
                        $permisos_funcionario= Doctrine::getTable('Correspondencia_FuncionarioUnidad')->funcionarioHistorico($funcionario->getId(), $unidad_consulta);
                        ...
                        foreach ($permisos_funcionario as $permiso) {
                            ...
                            <tr class="without_border" style="font-size: 10px">
                                ...
                                <td class="without_border actual" style="text-align: center"><?php echo ($permiso->getRedactar())? image_tag('icon/online.png', array('size'=>'12x12')) : image_tag('icon/offline.png', array('size'=>'12x12')); ?></td>
                                ...
                                <td class="without_border actual" style="text-align: center"><?php echo ($permiso->getRecibir())? image_tag('icon/online.png', array('size'=>'12x12')) : image_tag('icon/offline.png', array('size'=>'12x12')); ?></td>
                                <td class="without_border" style="text-align: center"><?php echo ($permiso->getFirmar())? image_tag('icon/online.png', array('size'=>'12x12')) : image_tag('icon/offline.png', array('size'=>'12x12')); ?></td>

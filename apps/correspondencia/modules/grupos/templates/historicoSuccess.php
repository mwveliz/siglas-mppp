...
<script>
    ...
    function ver_unidad_historicos()
    {
        ...
        $.ajax({
            url:'<?php echo sfConfig::get('sf_app_correspondencia_url'); ?>grupos/unidadHistorico',
            type:'POST',
            dataType:'html',
            data:'id='+unidad_id,
    ...
    <div id="sf_admin_footer">
        <ul class="sf_admin_actions trans">
            <li class="sf_admin_action_regresar_modulo">
                <a href="<?php echo sfConfig::get('sf_app_correspondencia_url'); ?>grupos/index">Regresar a permisos de grupo</a>
            </li>
        </ul>
    </div>

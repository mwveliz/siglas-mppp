...
<div id="plantillas_contenido" style="display: none;">
    <?php foreach ($plantillas as $plantilla) { ?>
        <div id="plantilla_informe_asunto_<?php echo $plantilla->getId(); ?>"><?php echo $plantilla->getCampoUno(); ?></div>
        <div id="plantilla_informe_contenido_<?php echo $plantilla->getId(); ?>"><?php echo html_entity_decode($plantilla->getCampoDos()); ?></div>
    <?php } ?>
</div>
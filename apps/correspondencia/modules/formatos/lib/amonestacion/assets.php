<script>
    $(document).ready(function()
    {
        ...
        //CAMPOS A VALIDAR
        $('#amonestacion_contenido_'+<?php echo $semilla ?>).rules("add", 'ckeditor_content');
    ...
    function setear_plantilla(pantilla_id) {
        $('#cke_contents_amonestacion_contenido_<?php echo $semilla; ?> iframe').contents().find('body').html($('#plantilla_amonestacion_contenido_'+pantilla_id).html());
    ...
    function guardar_plantilla() {
        ...
        if($.trim($('#input_plantilla_nueva').val())=='' || $.trim($('#input_plantilla_nueva').val())=='nombre de la plantilla'){
            ...
            var contenido = $('#cke_contents_amonestacion_contenido_<?php echo $semilla; ?> iframe').contents().find('body').html();

<div style="position: relative;" class="sf_admin_form_row sf_admin_text formato_seguimiento_ver">
    <div>
        <table width="100%"><tr><td><font class="f16b">Materiales</font></td><td><font class="f16b">Cantidad</font></td><td><font class="f16b">U. Medida</font></td></tr>
            <?php 
            if(isset($valores['materiales_material'])){
    ...
    <hr>
    <div>
        <font class="f16n"><?php if(isset($valores['materiales_observaciones'])) echo $valores['materiales_observaciones']; ?></font>
    </div>
    <div>

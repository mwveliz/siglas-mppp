<?php 
 ...
 $nombre = '';
    ...
    foreach ($estadistica_datos as $estadistica_dato){
        ...
        $por_firmar .= $estadistica_dato['por_firmar'].",";
        $enviadas .= $estadistica_dato['enviadas'].",";
        $entregadas .= $estadistica_dato['entregadas'].",";
        $pausadas .= $estadistica_dato['pausadas'].",";
...
$(function () {
	...
	lang: {
        ...
        chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Total de correspondencia enviada a oficinas'
            },
            subtitle: {
            ...
            plotOptions: {
                ...
                series: [
                    <?php
                        echo "{ name: 'Por Firmar', data: [$por_firmar] },\n";
                        echo "{ name: 'Enviadas', data: [$enviadas] },\n";
                        echo "{ name: 'Entregadas', data: [$entregadas] },\n";
                        echo "{ name: 'Pausadas', data: [$pausadas] },\n";

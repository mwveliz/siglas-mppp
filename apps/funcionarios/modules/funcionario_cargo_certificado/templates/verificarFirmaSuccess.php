...
<div id="div_firma_<?php echo $firma_emisor->getId(); ?>" style="display: none; position: absolute; padding: 5px; left: -60px; top: 20px; width: 550px; background-color: <?php echo $color; ?>; height: 200px; z-index: 300; border: solid;">
    ...
    <hr/>
    <div id="div_firma_detalles_<?php echo $firma_emisor->getId(); ?>" style="overflow-x: no-display; overflow-y: auto; width: 550px; height: 150px;">

<script>
    ...
    function fn_agregar(){
        if($("#funcionarios_familiar_discapacidad_discapacidad_id").val() )
        {       
                        
            cadena = "<tr>";  
            cadena += "<td><font class='f16b'>" + jQuery.trim($("#discapacidad").html()) + "</font><br/>";
            cadena += "<font class='f16n'>" + $("#funcionarios_familiar_discapacidad_discapacidad_id option:selected").text() + "</font>";
            cadena += "<td><input id='discapacidad[id]' name='discapacidad[id]' type='hidden' value='"  + $("#funcionarios_familiar_discapacidad_discapacidad_id").val() + "'/>" + "</td>";        
            cadena += "<td><a class='elimina' style='cursor: pointer;' ><img src='/images/icon/delete.png'/></a></td>";
            comp = $("#funcionarios_familiar_discapacidad_discapacidad_id").val();
            ...
            $("#funcionarios_familiar_discapacidad_discapacidad_id").val('');
    ...
    function saveInfoFamiliardiscapacidad() {
     ...
     var d = 0;
      ...
      if (mensajes!=''){
        ...
        $.ajax({
            url:'<?php echo sfConfig::get('sf_app_funcionarios_url'); ?>ficha/saveInfoFamiliardiscapacidad',
            type:'POST',
            dataType:'html',
            data:'grupoId='+grupoId,
            success:function(data, textStatus){
                $('#ficha_familiardiscapacidad_content').html(data);
...
<div id="sf_admin_container" style="width: 100%;">
    ...
    <div id="sf_admin_content">
        ...
        <fieldset id="sf_fieldset_email">
            ...
            <h2>Informacion Familiar Discapacidad</h2>
                        ...
                        <tbody>
                           <?php 
                            ...
                            <?php 
                                  ...
                                  $tipoDiscapacidad = Doctrine::getTable('Public_Discapacidad')->findById($discapacidad->getDiscapacidadId());
        ...
        <li class="sf_admin_action_save">
            <input id="guardar" type="button" value="Guardar" onclick="saveInfoFamiliardiscapacidad(); return false;">
        </li>
        <br/><br/>
    </div>
</div>
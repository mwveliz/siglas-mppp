    ...
    <tr>
        ...
        <td>
            <?php if($valores->getTipoDato()=='texto') { ?>
                <input name="valores_expediente[<?php echo $valores->getId(); ?>]" type="text"/>
            <?php } else if($valores->getTipoDato()=='numero') { ?>
                <input name="valores_expediente[<?php echo $valores->getId(); ?>]" type="text"/>
            <?php } else if($valores->getTipoDato()=='listado') { ?>
                <select name="valores_expediente[<?php echo $valores->getId(); ?>]">
                    <option value=""></option>
                    <?php 
            ...
            <?php } else if($valores->getTipoDato()=='fecha') { 
                ...
                echo $w->render('valores_expediente['.$valores->getId().'#f]');
            } ?>
        </td>
    </tr>
<?php } ?>

...
<script>
    $(document).ready(function(){
        $("form").submit(function() {
            ...
            if ($("#archivo_funcionario_unidad_autorizada_unidad_id").val() == "") {
...
<div class="sf_admin_form_row sf_admin_foreignkey sf_admin_form_field_archivo_funcionario_unidad_dependencia_unidad_id">
    ...
    <div>
        ...
        <div class="content">
            <select name="archivo_funcionario_unidad[autorizada_unidad_id]" id="archivo_funcionario_unidad_autorizada_unidad_id">

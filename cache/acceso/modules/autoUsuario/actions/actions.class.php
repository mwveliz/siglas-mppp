...
abstract class autoUsuarioActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->acceso_usuario = $this->form->getObject();
  }
  ...
  {
    $this->acceso_usuario = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->acceso_usuario);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'Acceso_Usuario'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->dispatcher->notify(new sfEvent($this, 'admin.save_object', array('object' => $acceso_usuario)));

      if ($request->hasParameter('_save_and_add'))
      {
        $this->getUser()->setFlash('notice', $notice.' You can add another one below.');

        $this->redirect('@acceso_usuario_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'acceso_usuario_edit', 'sf_subject' => $acceso_usuario));
      }
    }
    else
    {
  ...
  {
    $pager = $this->configuration->getPager('Acceso_Usuario');
  ...
  {
    return Doctrine_Core::getTable('Acceso_Usuario')->hasColumn($column);
  }
}
